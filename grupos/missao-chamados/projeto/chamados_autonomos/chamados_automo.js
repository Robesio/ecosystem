...
//comentario
function carregaAU() {
    fetch(UrlAu + "route.chamados_autonomos.php?id=0")
        .then(function (resp) {
            if (!resp.ok)
...
function addau() {
    ...
    if (autonomo_id.value != "" && solicitante_id.value != "" && status.value != "" && lat.value != "" && longi.value != "" && dia_hora.value != "") {
        ...
        xhr.addEventListener("readystatechange", function () {
            if (this.readyState === this.DONE) {
                ...
                if (resp.hasOwnProperty("erro")) {
                    ...
                    msg.innerHTML = "Chamados Criado Com Sucesso.";
                }
