    ...
    fetch(urlMateriais + "route.materiais.php?id=0")
        ...
        .then(function (data) {
            data.forEach((val) => {
                ...
                r.innerHTML += `<td style="padding:3px"><button onclick='edi(this)'><i class="fa fa-pencil" aria-hidden="true"></i></button>`;
                tableMateriais.appendChild(r);
            })//<button onclick='del(this)'><i class="fa fa-trash-o" aria-hidden="true"></i></button></td></tr>
        })
