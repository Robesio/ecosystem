    ...
    fetch(urlPorta + "route.porta_a_porta.php?id=0")
        ...
        .then(function (data) {
            data.forEach((val) => {
                ...
                row.innerHTML += `<button onclick='edit(this)'><i class="fa fa-pencil" aria-hidden="true"></i></button><button onclick='del(this)'><i class="fa fa-trash-o" aria-hidden="true"></i></button></td></tr>`;
...
function edit(p) {
    ...
    p.parentNode.parentNode.cells[5].innerHTML = "<button onclick='put(this)'>Enviar</button>";
}
